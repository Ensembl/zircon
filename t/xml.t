...
sub request_tt {
    ...
    eq_or_diff
      ($P->request_xml(vanish => 'view4'),
       q{<zmap app_id="Bob" request_id="0" socket_id="endpoint_remote" type="request" version="2.0">
<request command="vanish" view_id="view4" />
</zmap>}, 'request, empty');

    eq_or_diff
      ($P->request_xml(smudge => view5 => 'with finger'),
       q{<zmap app_id="Bob" request_id="1" socket_id="endpoint_remote" type="request" version="2.0">
...
with finger
    ...
    eq_or_diff
      ($P->request_xml(prod => view6 => [ finger => { side => 'left' } ]),
       q{<zmap app_id="Bob" request_id="2" socket_id="endpoint_remote" type="request" version="2.0">
...
<finger side="left" />
    ...
    eq_or_diff
      ($P->request_xml(prod => view7 => [ finger => { side => 'left' },
                                          [ speed => {}, 'quick' ] ]),
       q{<zmap app_id="Bob" request_id="3" socket_id="endpoint_remote" type="request" version="2.0">
...
sub reply_tt {
    ...
    eq_or_diff
      (MockProto->reply_xml
       (req5 => cmd5 => [ undef,
                          [ message => { }, 'Done that' ] ]),
       q{<zmap app_id="Bob" request_id="req5" socket_id="endpoint_local" type="reply" version="2.0">
    ...
    eq_or_diff
      (MockProto->reply_xml
       (req6 => cmd6 => [ [ 345, 'could not' ],
                          [ message => { }, 'I fell over' ] ]),
       q{<zmap app_id="Bob" request_id="req6" socket_id="endpoint_local" type="reply" version="2.0">
    ...
    eq_or_diff
      (MockProto->reply_xml
       (req7 => cmd7 => [ undef,
                          ...
                          [ data => { payload => 1 },
                            [ gubbins => {} => [ 'stop' ] ] ] ]),
       q{<zmap app_id="Bob" request_id="req7" socket_id="endpoint_local" type="reply" version="2.0">
